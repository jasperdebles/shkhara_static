...
<div class="min-h-screen bg-sky-950 flex items-center justify-center py-12 px-6">
    <div class="max-w-md w-full space-y-6">
        ...
        <form name="contact" method="POST" data-netlify="true" class="flex flex-col space-y-4">
            ...
            <textarea name="message" placeholder="Tell us about your current challenges!" class="w-full p-4 rounded-xl border border-white/30 bg-white/10 text-white placeholder-white/70 focus:outline-none focus:ring-2 focus:ring-sky-400"></textarea>
            <button 
